var Qixi = function () {
    var confi = {
        ...
        audio: {
            enable: true,
            playURl: "audio/missyou.mp3",
            cycleURL: "audio/missyou.mp3"
        },
        setTime: {
            walkToThird: 6000,
            walkToMiddle: 6500,
        ...
        snowflakeURl: ["images/snowflower1", "images/snowflower1","images/snowflower1",
            "images/snowflower1","images/snowflower1","images/snowflower1"]
    };
    var debug = 0;
    if (debug) {
